...
public enum ElasticMN {
	C11(11), C12(12), C13(13), C14(14), C15(15), C16(16), C21(21), C22(22), C23(
			23), C24(24), C25(25), C26(26), C31(31), C32(32), C33(33), C34(34), C35(
			35), C36(36), C41(41), C42(42), C43(43), C44(44), C45(45), C46(46), C51(
			51), C52(52), C53(53), C54(54), C55(55), C56(56), C61(61), C62(62), C63(
			63), C64(64), C65(65), C66(66);
	...
	public static ElasticMN valueOf(int m, int n) {
		...
		for (ElasticMN mn : values())
			if (mn.getValue() == k)
				return mn;
		throw new RuntimeException("input (m,n) : (" + m + ", " + n + ") is invalid");
	}
