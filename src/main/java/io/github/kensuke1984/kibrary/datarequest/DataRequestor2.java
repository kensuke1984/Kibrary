...
public class DataRequestor2 implements Operation {
    ...
    public DataRequestor2(Properties property) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        DataRequestor2 dr = new DataRequestor2(Property.parse(args));
        dr.run();
    ...
    public static void writeDefaultPropertiesFile() throws IOException {
        Path outPath = Paths.get(DataRequestor2.class.getName() + Utilities.getTemporaryString() + ".properties");
