...
// Lina changed		
		...
		System.out.println("model name is "+ structurePath + "!");
		if(structurePath.equals(Paths.get("AK135"))) {
			System.out.println("get!!");
			ps = PolynomialStructure.AK135;}
		else{
			System.out.println("Unfortunatelly unget");
			ps = structurePath == null ? PolynomialStructure.PREM
