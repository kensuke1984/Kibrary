 ...
 */
public class SshDSMInformationMaker_forStationFile implements Operation {

	public SshDSMInformationMaker_forStationFile(Properties property) {
	...
	public static void main(String[] args) throws Exception {
		SshDSMInformationMaker_forStationFile sdif = new SshDSMInformationMaker_forStationFile(Property.parse(args));
		long start = System.nanoTime();
		System.err.println(SshDSMInformationMaker_forStationFile.class.getName() + " is going.");
		sdif.run();
		System.err.println(SshDSMInformationMaker_forStationFile.class.getName() + " finished in "
				+ Utilities.toTimeString(System.nanoTime() - start));
	}

	public static void writeDefaultPropertiesFile() throws IOException {
		Path outPath = Paths
				.get(SshDSMInformationMaker_forStationFile.class.getName() + Utilities.getTemporaryString() + ".properties");
