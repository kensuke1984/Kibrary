 ...
 *
 */
public class ModifySAC {
	private static EventFolder eventDir;
	private static Set<EventFolder> idset;
	/**
	...
	public static void main(String[] args) throws IOException {
		...
		idset = Utilities.eventFolderSet(workPath);
		idset.stream().forEachOrdered( id -> {
     ...
     */
    ModifySAC(GlobalCMTData globalCMTData, Path sacPath, boolean byPDE) throws IOException {
    ...
    private void setInitialSacStartTime() {
        ...
        initialSacStartTime =
                LocalDateTime.of(nzyear, 1, 1, nzhour, nzmin, nzsec, nzmsec * 1000 * 1000).plusDays(nzjday - 1)
                        .plusNanos(bInNanos);
    }
